...
import { ref } from 'vue';
 const tasks = ref([
    {id:1,name:"Task1", time:60},
    {id:2,name:"Task2", time:75},
    {id:3,name:"Task3", time:95}
 ])
